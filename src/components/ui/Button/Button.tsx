...
export type ButtonVariants = "primary" | "tertiary" | "naked" | "grey";
    ...
    return (
      <button
        className={classnames(
          ...
          //   {
          //     "bg-transparent border border-current py-[9px] px-[7px]":
          //       variant === "outline",
          //   },
          {
          ...
          //   },
          //   {
          //     "opacity-70 hover:opacity-70 active:translate-y-0 cursor-not-allowed":
          //       disabled,
          //   },
